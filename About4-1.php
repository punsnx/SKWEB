...
<!-- DESKTOP NAV min-width: 600px -->
    ...
    <section class="mainsection-about41">
      <br>
      <h1 style="text-align: center; font-size: 300%;" class="animate__bounceIn">About 4/1</h1>
      <section class="ABOUT41">
        <div class="animate__bounceIn"><h3 class="ourig">Our Instragram :</h3>
          <a href="https://www.instagram.com/giftedsibsee/" class="ourigbt">giftedsibsee</a></div>
        <div class="animate__bounceIn"><table id="tabout401">
          <tr>
            <th>เลขที่</th>
            <th>ชื่อ-นามสกุล</th>
            <th>ชื่อเล่น</th>
          ...
          <tr>
            <td>01</td>
            <td>นายกฤติพงศ์ ตาแก้ว</td>
            <td>พลับ</td>
            <td>05/11/2004</td>
            <td><a href="/About4-1.html" class="aboutbtline">LINE</a></td>
            <td><a href="/About4-1.html" class="aboutbtfb">FACEBOOK</a></td>
            <td><a href="/About4-1.html" class="aboutbtig">INSTRAGRAM</a></td>
            <td>083-654-9994</td>
          </tr>
          <tr>
            <td>02</td>
            <td>นายกันต์ธัช นพภาพันธ์</td>
            <td>กันต์</td>
            <td>01/04/2005</td>
            <td><a href="/About4-1.html" class="aboutbtline">LINE</a></td>
            <td><a href="/About4-1.html" class="aboutbtfb">FACEBOOK</a></td>
