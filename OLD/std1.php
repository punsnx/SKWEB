...
<body style="background-color:lightgoldenrodyellow;" oncontextmenu="return false" onload="mainfunc()">
  ...
  <div class="responsive">
    ...
    <section class="mainsection">
      <br>
      <h1 style="text-align: center; font-size: 300%;" class="animate__bounceIn">Student 1 Information</h1>
      <section class="stdpicture">
        <div class="animate__bounceIn">
          <img src="/Pictures/TullJaturath.JPEG" alt="HELLOGIFHOME" style="border: 1px solid black;">
        </div>
      </section>
