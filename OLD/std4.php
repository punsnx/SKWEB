...
<!-- DESKTOP NAV min-width: 600px -->
    ...
    <section class="mainsection">
      <br>
      <h1 style="text-align: center; font-size: 300%;" class="animate__bounceIn">Student 4 Information</h1>
      <section class="stdpicture">
        <div class="animate__bounceIn">
        <img src="/Pictures/FeenPanuwat.JPEG" alt="HELLOGIFHOME" style="border: 1px solid black;">
      </div>
      </section>
