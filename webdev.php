...
<!-- DESKTOP NAV min-width: 600px -->
    ...
    <section class="mainsection">
      <br>
      <h1 style="text-align: center; font-size: 300%;" class="animate__bounceIn">Web Master</h1>
      <section class="stdpicture">
        <div class="animate__bounceIn">
        <img src="/Pictures/WebMaster.jpeg" alt="HELLOGIFHOME" style="border: 1px solid black;">
      </div>
      </section>
      <article class="rightarticle">
        <div class="animate__bounceIn"><table id="STDINFO">
          <tr>
            <th>หัวข้อ</th>
            <th>ข้อมูล</th>
          </tr>
          <tr>
            <td>ชื่อ-นามสกุล</td>
            <td>นายศิริสุข ทานธรรม</td>
          </tr>
          <tr>
            <td>ระดับชั้น</td>
            <td>มัธยมศึกษาปีที่ 4 (ห้อง 1)</td>
          </tr>
          <tr>
            <td>เลขที่</td>
            <td>10</td>
          ...
          <tr>
            <td>งานอดิเรก</td>
            <td>ดูหนัง, เล่นโซเชียล, ดู Youtube, อ่านการ์ตูน</td>
          </tr>
          <tr>
            <td>อาชีพในอนาคต</td>
            <td>Software Engineer, ครูคอมพิวเตอร์</td>
          </tr>
          <tr>
            <td>สาเหตุที่เลือกอาชีพนี้</td>
            <td>เพราะว่าชอบการเขียนโปรแกรม และการสอน</td>
          </tr>
        </table></div>
      </article>
